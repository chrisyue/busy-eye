(function() {
    ...
    setInterval(function() {
        if (frame.className.indexOf('busy-eye-mosaic-frame-translated') >= 0) {
            frame.className = frame.className.replace(' busy-eye-mosaic-frame-translated', '');
        } else {
            frame.className += ' busy-eye-mosaic-frame-translated';
        }
    }, 100);
})();
